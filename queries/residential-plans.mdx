...
<ResponseField name="rates" type="PlanRate[]">
  ...
  <Expandable title="rates[] fields">
    ...
    <ResponseField name="advertisedPriceUsdPerKwh" type="Float">
      The static EFL price at this usage benchmark, in $/kWh, as shown on the plan's Electricity Facts Label. Set by the supplier.
    </ResponseField>

    <ResponseField name="allInRateUsdPerKwh" type="Float">
      The all-in rate in $/kWh, including all fees and credits, seasonalized across the year. See [Pricing Concepts](/concepts/pricing) for what is included.
    </ResponseField>
