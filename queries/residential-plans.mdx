...
<ResponseField name="rates" type="PlanRate[]">
  ...
  <Expandable title="rates[] fields">
    ...
    <ResponseField name="advertisedPriceUsdPerKwh" type="Float">
      The static EFL price at this usage benchmark, in $/kWh, as shown on the plan's Electricity Facts Label. Calculated by the supplier and passed through unchanged.
    </ResponseField>
