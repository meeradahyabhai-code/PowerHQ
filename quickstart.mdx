...
<Steps>
  ...
  <Step title="Get your credentials">
    ...
    Contact your partner manager to receive your key. Want to run real queries before you have one? The [public sandbox](/playground) needs no key at all and runs on live production plans.
  </Step>

  <Step title="Choose your environment">
    PowerHQ provides two endpoints. Use the **Sandbox** environment while you build and test your integration. It returns test plans, not live prices. Point to **Production** when you go live.
