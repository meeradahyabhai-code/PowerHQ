---
title: "PowerHQ Plan Data API: Get Started With Your First Query"
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/authentication">
    Learn how the two-factor authentication model works — API key plus IP allow-listing — and how to handle 403 errors in production.
  </Card>
