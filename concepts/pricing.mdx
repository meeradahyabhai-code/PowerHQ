...
|---|---|
| `advertisedPriceUsdPerKwh` | The price per kWh at exactly 500, 1,000 or 2,000 kWh. This is the static EFL price at that benchmark, calculated by the supplier and passed through unchanged, and it does not reflect how a customer's usage varies month to month. |
...
| Field | What it represents |
|---|---|
| `advertisedPriceUsdPerKwh` | The static EFL price at that benchmark, calculated by the supplier. Outside Texas it is the variable supply rate per kWh and excludes any fixed monthly fee. |
