---
title: "API Authentication: Keys, IP Allow-Listing, and Errors"
sidebarTitle: "Authentication"
description: "Secure every PowerHQ API request with your API key and a registered server IP address — both are required before any call will succeed."
---
