...
description: "One platform for U.S. retail energy: plans, pricing, enrollment and compliance. Put our Drop-in Storefront on your site, or build your own experience on the PowerHQ API."
---

Retail energy is a hard market to enter and an easy one to underestimate. Every provider has its own
...
<CardGroup cols={3}>
  <Card title="Provider network" icon="plug">
  ...
  <Card title="Live pricing" icon="chart-line">
    Rates and availability updated directly from provider systems, not scraped or cached.
  </Card>
...
<Columns cols={2}>
  ...
  * Negotiate contracts with dozens of providers
  * Integrate outdated, inconsistent provider APIs
...
<Steps>
  <Step title="See the data">
    Open the [public sandbox](/playground) and run a real query. Nothing to sign, no key to request.
  </Step>
