...
<ResponseField name="advertisedPriceUsdPerKwh" type="Float!" required>
  The static EFL price at this usage benchmark, in $/kWh. Set by the supplier.
</ResponseField>

<ResponseField name="allInRateUsdPerKwh" type="Float!" required>
  The all-in rate in $/kWh, including all fees and credits, seasonalized across the year.
</ResponseField>
