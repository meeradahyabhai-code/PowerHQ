...
<ResponseField name="advertisedPriceUsdPerKwh" type="Float!" required>
  The static EFL price at this usage benchmark, in $/kWh. Calculated by the supplier and passed through unchanged, so it does not reflect how a customer's usage varies month to month.
</ResponseField>
