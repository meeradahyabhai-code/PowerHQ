...
description: "The Drop-in Storefront puts our shopping experience on your site in days. The PowerHQ API lets you build your own. Compare what you build, what you keep, and what each one costs you."
---
...
Everything behind the checkout is identical either way. Same providers, same plans, same enrollment,
...
|  | Drop-in Storefront <Badge color="green" size="sm" shape="pill">Recommended</Badge> | PowerHQ API |
| --- | --- | --- |
...
**Our shopping experience, running on your site, under your brand. We hold the provider contracts.**
...
component-level pricing, provider scores, disclosure documents and a ready-to-use enrollment URL per
...
- **PowerHQ owns the regulated parts.** Provider contracts, licensing, state-by-state compliance,
...
Or see the data first. Open the [public sandbox](/playground) and run a real query against live production data. No key, no signup. It is the same data behind both paths.
